...
The column _FSGRINC_ (which is the sum of _FSEARN_ and _FSUNEARN_) is the Final Gross Countable Unit Income. We'll use this as a measure of how much money the SNAP unit is making. Another analysis could look at just _FSEARN_ to see how earned income has changed over time.

```{r}
hist(snap_data_frames[[2011]]$FSGRINC[snap_data_frames[[2011]]$FSGRINC != 0])

par(mfrow=c(1,2))
plot(density(snap_data_frames[[2011]]$FSGRINC[snap_data_frames[[2011]]$FSGRINC != 0]), main="Density Plot of FSGRINC (2011)")
plot(density(snap_data_frames[[2003]]$FSGRINC[snap_data_frames[[2003]]$FSGRINC != 0]), main="Density Plot of FSGRINC (2003)")

boxplot(snap_data_frames[[2011]]$FSGRINC[snap_data_frames[[2011]]$FSGRINC != 0])
boxplot(snap_data_frames[[2003]]$FSGRINC[snap_data_frames[[2003]]$FSGRINC != 0])
```
...
str(snap_data_frames[[2011]]$RENT[snap_data_frames[[2011]]$RENT != 0])
str(snap_data_frames[[2003]]$RENT[snap_data_frames[[2003]]$RENT != 0])
```
