...
```{r}
hist(snap_data_frames[[2011]]$FSGRINC, main="Histogram of FSGRINC (2011)", breaks=50, xlim=c(0,5000))
hist(snap_data_frames[[2002]]$FSGRINC, main="Histogram of FSGRINC (2002)", breaks=50, xlim=c(0,5000))
```
